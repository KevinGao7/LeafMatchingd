...
#             CUDA_VISIBLE_DEVICES=$device nohup python dir_main2.py --dataset $dataset --split_ratio 0.9\
...
do
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=$device nohup python dir_main_htl.py --dataset $dataset --split_ratio 0.9\
            --h 12 --tp 16 --c 5 --neg 1 --r 0.2 --gamma 3 --pos_ratio 1 --alpha $alpha --epoch 50 --batch_size 256 \
            --seed $seed --chunks 1 --convergence 0.8 --eval_step 1\
            > ./logs/${dataset}-alpha333${alpha}-s${seed}.log 2>&1 &
