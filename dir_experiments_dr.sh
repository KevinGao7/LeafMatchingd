...
do
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=${device} nohup python dir_main_dr.py --dataset $dataset --split_ratio $ratio\
            ...
            > ./logs_dr/${dataset}/s${seed}-r${ratio}.log 2>&1 &
