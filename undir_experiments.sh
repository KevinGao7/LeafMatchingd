...
do
    ...
    do
        ...
        do
            ...
            # parallelly start the tasks
            CUDA_VISIBLE_DEVICES=$device nohup python undir_main.py --dataset $dataset --split_ratio $ratio --turn $turn\
            --h 16 --tp 16 --c 1 --neg 1 --gamma 3 --lam 1 --alpha 57 --epoch 150 --batch_size 8192 \
            --seed $turn \
            > ./logs/${dataset}/r${ratio}_s${turn}.log 2>&1 &
...
echo "Starting $dataset processing..."
    ...
    do
        ...
        # parallelly start the tasks
        CUDA_VISIBLE_DEVICES=$device nohup python undir_main.py --dataset $dataset --split_ratio $ratio --turn $turn\
        --h 16 --tp 16 --c 3 --neg 1 --gamma 6 --lam 1.33 --alpha 11 --epoch 100 --batch_size 8192 \
        --seed $turn \
        > ./logs/${dataset}-r${ratio}-t${turn}.log 2>&1 &
    done
...
echo "Starting $dataset processing..."
    ...
    do
        ...
        # parallelly start the tasks
        CUDA_VISIBLE_DEVICES=$device nohup python undir_main.py --dataset $dataset --split_ratio $ratio --turn $turn\
        --h 19 --tp 16 --c 1 --neg 1 --gamma 6 --lam 1 --alpha 24 --epoch 100 --batch_size 8192 \
        --seed $turn \
        > ./logs/${dataset}-r${ratio}-t${turn}.log 2>&1 &
    done
