...
import pandas as pd
import torch
from OurCogDL.cogdl.wrappers.data_wrapper.link_prediction.embedding_link_prediction_dw_dir1 import \
...
def split_dataset(name, split_ratio, data_type):
    ...
    datawrapper = EmbeddingLinkPredictionDataWrapper(dataset, icews18=(name == 'icews18'))
