...
do
    ...
    do
        ...
        do
            ...
            --h 13 --tp 16 --c 1 --neg 1 --gamma 4 --pos_ratio 1 --alpha 15 --epoch 150 --batch_size 256\
            --seed $seed --chunks 1 --convergence 0.8 --eval_step 1\
            > ./logs/${dataset}/s${seed}-r${ratio}.log 2>&1 &
...
#             CUDA_VISIBLE_DEVICES=${device} nohup python dir_main.py --dataset $dataset --split_ratio $ratio\
#             --h 13 --tp 16 --c 3 --neg 1 --gamma 4 --pos_ratio 1 --alpha 2 --epoch 75 --batch_size 256\
#             --seed $seed --chunks 1 --convergence 0.8 --eval_step 1\
#             > ./logs/${dataset}/s${seed}-r${ratio}.log 2>&1 &
...
#             CUDA_VISIBLE_DEVICES=${device} nohup python dir_main.py --dataset $dataset --split_ratio $ratio\
#             --h 13 --tp 16 --c 1 --neg 1 --gamma 4 --pos_ratio 1 --alpha 15 --epoch 100 --batch_size 256\
#             --seed $seed --chunks 1 --convergence 0.8 --eval_step 1\
#             > ./logs/${dataset}/s${seed}-r${ratio}.log 2>&1 &
...
#             CUDA_VISIBLE_DEVICES=${device} nohup python dir_main.py --dataset $dataset --split_ratio $ratio\
#             --h 14 --tp 16 --c 1 --neg 1 --gamma 8 --pos_ratio 1 --alpha 180 --epoch 100 --batch_size 256\
...
#             CUDA_VISIBLE_DEVICES=${device} nohup python dir_main.py --dataset $dataset --split_ratio $ratio\
#             --h 12 --tp 16 --c 1 --neg 1 --gamma 5 --pos_ratio 1.5 --alpha 3 --epoch 75 --batch_size 128\
...
#                 CUDA_VISIBLE_DEVICES=$device nohup python dir_main.py --dataset $dataset --split_ratio $ratio\
#                 --h 13 --tp 16 --c 1 --neg 1 --gamma 6 --pos_ratio 1 --alpha 15 --epoch 50 --batch_size 64\
...
#             CUDA_VISIBLE_DEVICES=${device} nohup python dir_main.py --dataset $dataset --split_ratio $ratio\
#             --h 15 --tp 16 --c 1 --neg 1 --gamma 5 --pos_ratio 5 --alpha 20 --epoch 100 --batch_size ${_batch_size}\
